...
public final class ROQShader {

    private final RiseShaderProgram program = new RiseShaderProgram("roq.frag", "vertex.vsh");

    public void draw(float x, float y, float w, float h, float radius, float borderWidth, Color color) {
